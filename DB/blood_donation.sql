...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2022 at 10:22 AM
...
CREATE TABLE `bloodbank` (
  ...
  `organised_by` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `blooddonors` (
  ...
  `ldb` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `blooddonors` (`id`, `name`, `number`, `city`, `state`, `blood_group`, `gender`, `ldb`, `unit`, `status`, `image`, `created_at`, `updated_at`) VALUES
(1, 'Admin', '9876543210', '1503', '15', 'B-', 'm', '2022-09-14', '4', 'Complete', '1662962274.jpg', '2022-09-12 00:27:54', '2022-09-12 00:27:54'),
(2, 'Admin', '9876543210', '1217', '12', 'B-', 'm', '2022-09-14', '1', 'Complete', '1662962530.jpg', '2022-09-12 00:32:10', '2022-09-12 00:32:10'),
(3, 'Mahi', '9876543210', '1613', '16', 'O-', 'm', '2022-09-21', '1', 'Complete', '1662966236.jpg', '2022-09-12 01:33:56', '2022-09-12 01:33:56'),
(4, 'Admin', '1234567894', '1718', '17', 'O-', 'f', '2022-09-10', '1', 'Pending', '1662968227.jpg', '2022-09-12 02:07:07', '2022-09-12 02:07:07');
...
CREATE TABLE `bloodrequest` (
  ...
  `state` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `city` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `need_date` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `blood_group` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `bloodrequest` (`id`, `name`, `cname`, `number`, `state`, `city`, `need_date`, `blood_group`, `gender`, `unit`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'user', '9876543210', 'Rajasthan', 'udaipur', '2022-09-18', 'B+', 'm', '2', 'Pending', '2022-09-09 02:45:49', '2022-09-09 02:45:49'),
(2, 'Admin', 'user', '9876543210', '3', '308', '2022-09-10', 'B+', 'm', '1', 'Pending', '2022-09-09 02:51:57', '2022-09-09 02:51:57'),
(3, 'Admin', 'user', '9876543210', '29', '2910', '2022-09-01', 'B-', 'f', '2', 'Pending', '2022-09-11 23:36:29', '2022-09-11 23:36:29');

-- --------------------------------------------------------

--
-- Table structure for table `campes`
--
...
(1, '1662958423.jpg', '2022-09-11 23:23:43', '2022-09-11 23:23:43'),
(2, '1662958431.jpg', '2022-09-11 23:23:51', '2022-09-11 23:23:51'),
(3, '1662958442.jpg', '2022-09-11 23:24:02', '2022-09-11 23:24:02'),
(4, '1662958452.jpg', '2022-09-11 23:24:12', '2022-09-11 23:24:12'),
(5, '1662958461.jpg', '2022-09-11 23:24:21', '2022-09-11 23:24:21'),
(6, '1662958468.jpg', '2022-09-11 23:24:28', '2022-09-11 23:24:28'),
(7, '1662958475.jpg', '2022-09-11 23:24:35', '2022-09-11 23:24:35'),
(8, '1662958482.jpg', '2022-09-11 23:24:42', '2022-09-11 23:24:42');
...
(6, '2022_08_26_102324_create_bloodrequest_table', 1),
...
(45, '2022_08_26_075215_create_blooddonors_table', 2),
(46, '2022_08_29_030427_create_slider_table', 2),
(47, '2022_09_02_083627_create_bloodrequest_table', 2),
(48, '2022_09_05_015534_create_campes_table', 2),
(49, '2022_09_06_055707_create_gallery_table', 2),
(50, '2022_09_07_111051_create_testiomal_table', 2),
(51, '2022_09_08_013638_create_bloodbank_table', 2);
...
INSERT INTO `slider` (`id`, `heading`, `paragraph`, `status`, `image`, `created_at`, `updated_at`) VALUES
(1, 'Donate blood,save life !', 'DONATE BLOOD AND INSPIRES OTHERS.', '1', '1662711081.jpg', '2022-09-09 02:41:21', '2022-09-09 02:41:21'),
(2, 'Donate blood,save life !', 'DONATE BLOOD AND INSPIRES OTHERS.', '1', '1662711094.jpg', '2022-09-09 02:41:34', '2022-09-09 02:41:34');

-- --------------------------------------------------------

--
-- Table structure for table `testiomal`
--

CREATE TABLE `testiomal` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paragraph` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Admin', 'user', 'admin@gmail.com', NULL, '$2y$10$ANuWZV1qz4dT2RkI8DwMlucVdrzlq.U9Z0mS9ZP7byWAvFZXKl71.', NULL, '2022-09-09 02:36:34', '2022-09-09 02:36:34');
...
--
-- Indexes for table `testiomal`
--
ALTER TABLE `testiomal`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `campes`
--
ALTER TABLE `campes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `testiomal`
--
ALTER TABLE `testiomal`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
