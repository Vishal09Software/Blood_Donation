                            ...
                            <div class="footer-widget">
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <div class="textwidget">
                                        ...
                                        <p><a href="#">support@donation.com</a></p>
                            ...
                            <div class="footer-widget clearfix">
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <ul class="footer-useful-links">
                                        <li>
                                            <a href="{{'/'}}">
                                                <i class="fa fa-caret-right fa-footer"></i> Home
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{'/about'}}">
                                                <i class="fa fa-caret-right fa-footer"></i> About Us
                                            </a>
                                        </li>

                                        <li>
                                            <a href="{{'/gallery'}}">
                                                <i class="fa fa-caret-right fa-footer"></i> Gallery
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{'/search_donor'}}">
                                                <i class="fa fa-caret-right fa-footer"></i> Search Donor
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{'/campes'}}">
                                                <i class="fa fa-caret-right fa-footer"></i>Campes
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{'/contact'}}">
                                                <i class="fa fa-caret-right fa-footer"></i> Contact
                                            </a>
                                        </li>
                ...
                <div class="container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 text-center">
                            <p class="copyright-text"> Copyright 2018 - Blood Buddies By <a href="https://technotwist.in/"> Technotwist </a> . All Rights Reserved. </p>
                        </div>
                        <!-- end .col-sm-6  -->
        ...
        <script src="{{ url('frontend/js/jquery.backTop.min.js') }}"></script>
        <script src="{{ url('frontend/js/waypoints.min.js') }}"></script>
        <script src="{{ url('frontend/js/waypoints-sticky.min.js') }}"></script>
        ...
        <script src="{{ url('frontend/js/custom-scripts.js') }}"></script>
